...
<head>
    ...
    <!-- Link boostrap js -->
    <script
            Content-Security-Policy:src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js"
    ...
    <script
            Content-Security-Policy:src="https://kit.fontawesome.com/a076d05399.js"
            crossorigin="anonymous"
    ></script>
    ...
    <script Content-Security-Policy:src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
    <script Content-Security-Policy:src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.8.0/jszip.js"></script>
    <script Content-Security-Policy:src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.8.0/xlsx.js"></script>
