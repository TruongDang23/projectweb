<%-- Created by IntelliJ IDEA. User: GIGABYTE Date: 11/24/2023 Time: 1:03 PM To change this template use File | Settings
    | File Templates. --%>
    ...
    <div id="wrapper">
        <aside id="sidebar-wrapper">
            ...
            <ul class="sidebar-nav">
                ...
                <li>
                    <a class="mt-3" href="<%=request.getContextPath()%>/views/quanli/QuanLiPhongBan.jsp"><i class="fa fa-sitemap"></i>Quản lý phòng ban</a>
                </li>
                <li>
